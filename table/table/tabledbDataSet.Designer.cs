    ...
    public partial class tabledbDataSet : global::System.Data.DataSet {
        ...
        public partial class authRow : global::System.Data.DataRow {
            ...
            public string username {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'username\' в таблице \'auth\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsusernameNull() {
                return this.IsNull(this.tableauth.usernameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetusernameNull() {
                this[this.tableauth.usernameColumn] = global::System.Convert.DBNull;
            }
...
namespace table.tabledbDataSetTableAdapters {
    ...
    public partial class authTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `auth` WHERE ((`ID` = ?) AND ((? = 1 AND `username` IS NULL) OR (`use" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `auth` (`username`, `password`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `auth` SET `username` = ?, `password` = ? WHERE ((`ID` = ?) AND ((? = 1 AN" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, username, [password] FROM auth";
        ...
        public virtual int Fill(tabledbDataSet.authDataTable dataTable) {
        ...
        public virtual tabledbDataSet.authDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            tabledbDataSet.authDataTable dataTable = new tabledbDataSet.authDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(tabledbDataSet.authDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(tabledbDataSet dataSet) {
